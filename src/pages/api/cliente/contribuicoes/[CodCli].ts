...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  if (req.method === "GET") {
    ...
    const contribuicoes = await db("servico1")
      ...
      .offset(offset)
      .select("servico1.Lanc", "servico1.CodPro", "servico1.Data", "servico1.Hora", "servico1.Transito", "servico1.CodFor", "servico1.CodCli", "Clientes.Cliente as NomeRestaurante");
