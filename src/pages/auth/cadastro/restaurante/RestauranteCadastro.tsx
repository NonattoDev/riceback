  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="CGC" className="block text-sm font-medium text-gray-700">
            CNPJ
          </label>
          <InputMask
        ...
        <div>
          ...
          <input type="text" name="Cliente" id="Cliente" value={formData.Cliente} onChange={handleChange} className="mt-1 p-2 border border-gray-300 rounded w-full" />
        </div>
        <div>
          <label htmlFor="IE" className="block text-sm font-medium text-gray-700">
            Inscrição Estadual
          </label>
          <input type="text" name="IE" id="IE" value={formData.IE} onChange={handleChange} className="mt-1 p-2 border border-gray-300 rounded w-full" />
        </div>
        ...
        <div>
          ...
          <input type="text" name="bairro" id="bairro" value={formData.bairro} onChange={handleChange} className="mt-1 p-2 border border-gray-300 rounded w-full" maxLength={25} />
        </div>
        <div>
